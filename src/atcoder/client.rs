...
pub trait AtCoderClient {
    fn fetch_contest_list(&self, page: u32) -> Result<Vec<AtCoderContest>>;
    fn fetch_submission_list(
        &self,
        contest_id: &str,
        page: Option<u32>,
    ) -> Result<AtCoderSubmissionListResponse>;
    fn fetch_problem_list(&self, contest_id: &str) -> Result<Vec<AtCoderProblem>>;
}

impl AtCoderClient for HttpClient {
    fn fetch_contest_list(&self, page: u32) -> Result<Vec<AtCoderContest>> {
